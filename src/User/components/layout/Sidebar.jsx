...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <aside className="card" style={sidebarStyle}>
      <ul style={ulStyle}>
        {/* Dashboard Item */}
        <Link to="/user/admin/dashboard" style={{ textDecoration: "none" }}>
          <li
        ...
        {/* complaint Item */}
        <Link to="/user/admin/complaints" style={{ textDecoration: "none" }}>
          <li
            className="sidebarItem"
            style={sidebarItemStyle}
            onMouseEnter={(e) => {
        ...
        {/* Request Item */}
        <Link to="/user/admin/requests" style={{ textDecoration: "none" }}>
          <li
            className="sidebarItem"
            style={sidebarItemStyle}
            onMouseEnter={(e) =>
        ...
        {/* Users Item */}
        <Link to="/user/admin/user-manage" style={{ textDecoration: "none" }}>
          <li
            className="sidebarItem"
            style={sidebarItemStyle}
            onMouseEnter={(e) => {
