        ...
        >
            ...
            <Stack direction="row" spacing={1.25} alignItems="center">
              ...
              <Box>
                ...
                <Typography variant="caption" sx={{ color: "#64748b" }}>
                  This will change the selected request.
                </Typography>
              </Box>
            </Stack>
          </DialogTitle>
          <DialogContent sx={{ px: 2.25, pt: 1.75, pb: 1 }}>
            <DialogContentText sx={{ color: "#475569", fontSize: 14, lineHeight: 1.6 }}>
              Please confirm before updating the request status. You can continue from the details
  ...
  return (
    <Box sx={{ maxWidth: 640, mx: "auto" }}>
      ...
      >
        <Box sx={{ p: { xs: 1.5, sm: 2 } }}>
          <Stack direction="row" alignItems="center" spacing={1.25}>
            ...
            <Chip
              label={isInitialLoading ? "..." : requests.length}
              sx={{
                minWidth: 42,
                height: 34,
                borderRadius: 2,
      ...
      {isInitialLoading ? (
        ...
        >
          <Stack alignItems="center" spacing={1.25} sx={{ py: 6, px: 2, textAlign: "center" }}>
            ...
            <Typography variant="body2" sx={{ color: "#64748b", maxWidth: 320 }}>
              Checking requests assigned to you.
            </Typography>
          </Stack>
        </Card>
      ) : requests.length === 0 ? (
        ...
        <Stack spacing={1.25}>{requests.map(renderRequestCard)}</Stack>
      )}
    </Box>
  );
}
